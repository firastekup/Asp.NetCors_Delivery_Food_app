...
namespace DeleveryApp.Data.Migrations
{
    ...
    [Migration("20240504164307_migrain2")]
    partial class migrain2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeleveryApp.Models.Admin", b =>
                {
            ...
            modelBuilder.Entity("DeleveryApp.Models.Client", b =>
                {
            ...
            modelBuilder.Entity("DeleveryApp.Models.Commande", b =>
                {
                    ...
                    b.HasIndex("FoodIdAliment");

                    b.ToTable("Commande");
                });

            modelBuilder.Entity("DeleveryApp.Models.Food", b =>
                {
                    b.Property<int>("IdAliment")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DeleveryApp.Models.Livreur", b =>
                {
                    b.Property<int>("IdLivreur")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DeleveryApp.Models.Commande", b =>
                {
                    b.HasOne("DeleveryApp.Models.Food", "Food")
                        .WithMany()
                        .HasForeignKey("FoodIdAliment")
